$(document).ready(function() {
	...
	$('fieldset.inquiry').hide();
	$('fieldset.complaint').hide();
	$('fieldset.purchase').hide();
	$('fieldset.payment').hide();
	$('fieldset.document').hide();
	...
	//VIEW CUSTOMER ACCORDNG TO TYPE
	$("#typeofcustomer").text(function(){
